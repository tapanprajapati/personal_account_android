...
export default class CategoryLine extends Component{
    ...
    componentDidMount(){
        ...
        this.state.months.forEach(month=>{
            ...
            this.categoryHandler.getCategoryTotalByMonthYear(monthYear,this.props.type).then(categories=>{
    ...
    setCategories = (categories) => {
        ...
        categories.forEach(category=>{
            ...
            const found = this.state.categories.find(c=> c.category.id==category.id)
